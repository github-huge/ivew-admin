<template>
  <div :class="wrapperClasses" ref="outerWrapper">
    <div :class="`${prefix}-horizontal`" v-if="isHorizontal">
      <div :class="[`${prefix}-pane`, 'left-pane']" :style="{right: `${anotherOffset}%`}">
        <slot name="left"/>
      </div>
      ...
      <div :class="[`${prefix}-pane`, 'right-pane']" :style="{left: `${offset}%`}">
        <slot name="right"/>
      </div>
    </div>
    <div :class="`${prefix}-vertical`" v-else>
      <div :class="[`${prefix}-pane`, 'top-pane']" :style="{bottom: `${anotherOffset}%`}">
        <slot name="top"/>
      </div>
      ...
      <div :class="[`${prefix}-pane`, 'bottom-pane']" :style="{top: `${offset}%`}">
        <slot name="bottom"/>
      </div>
    </div>
  </div>
  ...
  export default {
    ...
    methods: {
      ...
      handleMove(e) {
        ...
        e.atMax = this.valueIsPx ? this.getAnotherOffset(this.value) === this.computedMax : this.getAnotherOffset(this.value)
          .toFixed(5) === this.computedMax.toFixed(5)

<template>
  <div class="tables-edit-outer">
    <div class="tables-edit-con" v-if="!isEditting">
      <span class="value-con">{{ value }}</span>
      <Button @click="startEdit" class="tables-edit-btn" style="padding: 2px 4px;" type="text" v-if="editable">
        <Icon type="md-create"></Icon>
      </Button>
    </div>
    <div class="tables-editting-con" v-else>

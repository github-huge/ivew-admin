    ...
    <i-col span="12">
      <Card>
        <div class="update-paste-con">
          <paste-editor @on-error="handleError" @on-success="handleSuccess" v-model="pasteDataArr"/>
        </div>
        <div class="update-paste-btn-con">
          <span class="paste-tip">使用Tab键换列，使用回车键换行</span>
          <Button @click="handleShow" style="float: right;" type="primary">显示表格数据</Button>
        </div>
      </Card>
    </i-col>
    <i-col span="12">
      <Card>
        <Table :columns="columns" :data="tableData" :height="400"/>
      </Card>
    </i-col>
  </Row>
</template>

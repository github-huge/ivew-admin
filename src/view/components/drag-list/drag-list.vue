  ...
  <div>
    <Card>
      <div class="drag-box-card">
        ...
        <drag-list :dropConClass="dropConClass" :list1.sync="list1" :list2.sync="list2" @on-change="handleChange">
      ...
      <div class="handle-log-box">
        ...
        <div class="handle-inner-box">
          <p :key="`handle_item_${index}`" v-for="(item, index) in handleList">{{ item }}</p>
        </div>
      </div>

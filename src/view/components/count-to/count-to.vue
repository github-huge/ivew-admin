    ...
    <Row :gutter="14">
      <i-col span="3">
        <Card>
          ...
          <Row align="middle" class="countto-page-row" justify="center" type="flex">
      ...
      <i-col class="padding-left-10" span="5">
        <Card>
          <p slot="title">
            <Icon type="code"></Icon>
            可添加左右文字
      ...
      <i-col class="padding-left-10" span="8">
        <Card>
          <p slot="title">
      ...
      <i-col class="padding-left-10" span="8">
        <Card>
          ...
          <Row align="middle" class="countto-page-row" justify="center" type="flex">
            <div class="count-to-con">
              <count-to :decimals="2" :end="2534" count-class="count-text" unit-class="unit-class">
                <span class="slot-text" slot="left">Total:&nbsp;</span>
                <span class="slot-text" slot="right">&nbsp;times</span>
              </count-to>
            </div>
    ...
    <Row :gutter="14" style="margin-top: 14px;">
      ...
      <i-col class="padding-left-10" span="8">
        <Card>
          ...
          <Row align="middle" class="countto-page-row" justify="center" type="flex">
            <div class="count-to-con">
              <count-to :end="253" :simplify="true" :unit="unit" count-class="count-text" unit-class="unit-class">
                <span class="slot-text" slot="left">原始数据：253&nbsp;=>&nbsp;</span>
              </count-to>
              <count-to :end="2534" :simplify="true" :unit="unit" count-class="count-text" unit-class="unit-class">
                <span class="slot-text" slot="left">原始数据：2534&nbsp;=>&nbsp;</span>
              </count-to>
              <count-to :end="257678" :simplify="true" :unit="unit" count-class="count-text" unit-class="unit-class">
    ...
    <Row :gutter="14" style="margin-top: 14px;">
      <i-col>
        <Card>
          ...
          <Row align="middle" class="countto-page-row" justify="center" type="flex">
            <div class="count-to-con">
              <count-to :delay="500" :end="integratedEndVal" :simplify="true" :unit="unit2" count-class="count-text"

<template>
  <div class="zoom-wrapper">
    <button @click="scale('down')" class="zoom-button">
      <Icon :size="14" color="#fff" type="md-remove"/>
    </button>
    <span class="zoom-number">{{ value }}%</span>
    <button @click="scale('up')" class="zoom-button">
      <Icon :size="14" color="#fff" type="md-add"/>
    </button>
  </div>
</template>

<template>
  <div class="resume">
    <div class="about">
      ...
      <div class="intention">求职意向：<br/>
        <span>web前端工程师</span></div>
      <div class="info">
    ...
    <div class="power">
      <div class="power-item">
        ...
        <div class="technology-item">
          <span>【前端】</span>HTML/HTML5 &nbsp CSS/CSS3 &nbsp JavaScript(ES6,ES5) &nbsp SASS &nbsp Stylus &nbsp Vue.JS
          &nbsp AJAX &nbsp jQuery &nbsp 微信小程序 &nbsp Babel
        </div>
        <div class="technology-item">
      ...
      .info
        ...
        .info-item
          ...
          .icon
            ...
            &.school
              background-image: url(../../../assets/chatImages/school.png)

            &.major
              background-image: url(../../../assets/chatImages/major.png)

            &.phone
              background-image: url(../../../assets/chatImages/phone.png)
              background-size: 32px

            &.email
              background-image: url(../../../assets/chatImages/email.png)
        ...
        .title
          ...
          .icon
            ...
            &.technology
              ...
              background-image: url(../../../assets/chatImages/technology.png)

            &.evaluation
              background-image: url(../../../assets/chatImages/evaluation.png)
